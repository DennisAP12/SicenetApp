...
class LoginRepository(private val api: SicenetApi) {  // <-- clase normal
    ...
    suspend fun login(matricula: String, contrasenia: String, tipoUsuario: String) =
        api.login(buildLoginXml(matricula, contrasenia, tipoUsuario))
}